            ...
            <div class="modal-body">
				<form method = "post" enctype = "multipart/form-data">
					...
					<div class="form-group">
						<label>Party</label>
							<input class="form-control" type ="text" name = "party" required="true" value = "<?php echo $row ['party']?>">
					</div>

					<div class="form-group">
						<label>Platform</label>
							<input class="form-control" type ="text" name = "platform" required="true" value = "<?php echo $row ['platform']?>">
					</div>
...
<!-- /.modal-content -->
	...
	<?php
		...
		if(ISSET($_POST['update'])){
			...
			$conn->query("UPDATE candidate SET  party = '$party', platform = '$platform', position = '$position', firstname = '$firstname', lastname = '$lastname', year_level = '$year_level', gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'")or die(mysql_error());
