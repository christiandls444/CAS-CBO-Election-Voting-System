        ...
        <div class="modal-content">
            <div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">
					<div class="panel panel-primary" style="background-color: #242424">
						<div class="panel-heading" style="background-color: #242424">
							<center><b>EDIT CANDIDATE</b></center>
						</div>
					</div>
				</h4>
			</div>
            ...
            <div class="modal-body">
				<form action="update_user.php?user_id=<?php echo $user_id; ?>" method = "post" >
					...
					<button name = "change" type="submit" class="btn btn-info">SAVE USER</button>
				</form>
			</div>
