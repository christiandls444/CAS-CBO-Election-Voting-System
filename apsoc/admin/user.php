...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><b>SYSTEM USER LIST</b></h2>

                </div>

				<button class="btn btn-info" data-toggle="modal" data-target="#add_user">Add User</button>
										...
										?>
                                            ...
                                            <td style="text-align:center">
											 ...
											 <?php include ('delete_user_modal.php'); ?>
												  <a rel="tooltip"  title="Edit" id="<?php echo $row['user_id'] ?>" href="#edit_user<?php echo $row['user_id'] ?>"  data-toggle="modal"class="btn btn-warning btn-outline"><i class="fa fa-pencil"></i> Edit</a>
