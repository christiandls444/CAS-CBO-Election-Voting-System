                                    ...
                                    <div class="modal-content">
										...
										<form method = "post" enctype = "multipart/form-data">
											<div class="form-group">
												<label>USENAME</label>
												<input class ="form-control" type = "text" name = "username" placeholder = "Please input your username" required="true">
											...
											<div class="form-group">
												<label>LASTNAME</label>
												 ...
												 <button name = "ok" type="submit" class="btn btn-info">SAVE USER</button>
