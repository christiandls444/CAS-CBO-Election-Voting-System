<?php
	...
	session_destroy();
		...
		$conn->query("INSERT INTO `votes` VALUES('', '$_SESSION[sgtarm_idd]', '$_SESSION[voters_id]')") or die(mysql_error());
		$conn->query("INSERT INTO `votes` VALUES('', '$_SESSION[sgtarm_iddd]', '$_SESSION[voters_id]')") or die(mysql_error());
		$conn->query("INSERT INTO `votes` VALUES('', '$_SESSION[sgtarm_idddd]', '$_SESSION[voters_id]')") or die(mysql_error());
