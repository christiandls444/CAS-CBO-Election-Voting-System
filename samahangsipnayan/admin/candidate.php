...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><b>CANDIDATES LIST</b></h2>

                </div>

				<button class="btn btn-info" data-toggle="modal" data-target="#myModal">Add Candidate</button>
										...
										?>
                                            ...
                                            <td style="text-align:center">
											 ...
											 <?php include ('delete_candidate_modal.php'); ?>
												  <a rel="tooltip"  title="Edit" id="<?php echo $row['candidate_id'] ?>" href="#edit_candidate<?php echo $row['candidate_id'] ?>"  data-toggle="modal"class="btn btn-warning btn-outline"><i class="fa fa-pencil"></i> Edit</a>
