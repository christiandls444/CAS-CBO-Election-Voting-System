...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<select name="position" id="position" class = "form-control pull-left" style = "width:300px;margin-left:19px; ">
				...
				<option>First Representative</option>
        <option>Second Representative</option>
        <option>Third Representative</option>
        <option>Fourth Representative</option>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:600px;"class = "btn-info">Candidate for First Representative</td>
						<td style = "width:200px;" class = "btn-info">Image</td>
						<td class = "btn-info">Total</td>
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'First Representative'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
    ...
    <table class="table table-striped table-bordered table-hover ">
        <thead>
          <td style = "width:600px;"class = "btn-info">Candidate for Second Representative</td>
          <td style = "width:200px;" class = "btn-info">Image</td>
          <td class = "btn-info">Total</td>
        ...
        <?php
  require 'dbcon.php';
  $query = $conn->query("SELECT * FROM candidate WHERE position = 'Second Representative'");
  while($fetch = $query->fetch_array())
  {
    $id = $fetch['candidate_id'];
    $query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
...
?>
  ...
  <table class="table table-striped table-bordered table-hover ">
      <thead>
        <td style = "width:600px;"class = "btn-info">Candidate for Third Representative</td>
        <td style = "width:200px;" class = "btn-info">Image</td>
        <td class = "btn-info">Total</td>
      ...
      <?php
require 'dbcon.php';
$query = $conn->query("SELECT * FROM candidate WHERE position = 'Third Representative'");
while($fetch = $query->fetch_array())
{
  $id = $fetch['candidate_id'];
  $query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
...
<table class="table table-striped table-bordered table-hover ">
    <thead>
      <td style = "width:600px;"class = "btn-info">Candidate for Fourth Representative</td>
      <td style = "width:200px;" class = "btn-info">Image</td>
      <td class = "btn-info">Total</td>
    ...
    <?php
require 'dbcon.php';
$query = $conn->query("SELECT * FROM candidate WHERE position = 'Fourth Representative'");
while($fetch = $query->fetch_array())
{
$id = $fetch['candidate_id'];
$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
